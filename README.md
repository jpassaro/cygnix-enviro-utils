...
then, login someplace else (use password if you have to i guess) and get your
key in. remember you can always reuse the key from github and call
github.com/$USER.keys to get its public key.


# Copyright

All code is copyright John Passaro 2017-2019 and released under the GPL. See
LICENSE.
